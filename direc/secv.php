...
// Obtener cursos de nivel secundaria
$stmt = $conn->query("SELECT c.id_curso, c.curso, c.paralelo FROM cursos c WHERE c.nivel = 'Secundaria' ORDER BY c.curso, c.paralelo");
...
<head>
    <meta charset="UTF-8">
    <title>Centralizadores Secundaria</title>
...
<body>
    ...
    <div class="main-content">
        <div class="bg-white rounded shadow-sm p-4 mb-4">
            <h2 class="mb-0" style="color:#7bb27d;">Centralizadores de Nivel Secundaria</h2>
        ...
        <div class="table-responsive">
            <table class="table table-centralizador align-middle">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="3" class="text-center">No hay cursos de nivel secundaria registrados.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
