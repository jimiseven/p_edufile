...
// Compacta el nombre de la materia
...
<head>
    ...
    <style>
        ...
        tr:nth-child(even) td:not(.col-estudiante):not(.col-numero) {
            background-color: #fdfdfd;
        }

        tr:nth-child(odd) td:not(.col-estudiante):not(.col-numero) {
        ...
        .tabla-centralizador td:not(.col-estudiante):not(.col-numero) {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header-curso">
            <?= htmlspecialchars(strtoupper($curso['nivel'] . ' - ' . $curso['curso'] . ' "' . $curso['paralelo'] . '"')) ?>
        </div>
                ...
                <table class="tabla-centralizador">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($estudiantes as $est): ?>
                            <tr>
                                <td class="col-numero"><?= $contador++ ?></td>
