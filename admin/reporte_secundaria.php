...
// Forzar activación del sidebar para asignación de secundaria
$_SESSION['force_active'] = 'asig_sec';
...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Asignaciones - Secundaria</title>
    ...
    <style>
        :root {
            --sidebar-width: 250px;
            --color-primario: #3a5e3a;
            --color-secundario: #7bb27d;
            --color-fondo: #f8f9fa;
        }
    ...
    <div class="main-content">
        <div class="actions-bar no-print">
            <div>
                ...
                <small class="text-muted">Nivel Secundaria - <?= date('d/m/Y') ?></small>
            </div>
            <div class="d-flex gap-2">
                <a href="asig_sec.php" class="btn btn-outline-secondary">
